...
template<int d> Vector<int, d> Grid<d>::Coord(const int index, const VectorDi& counts) { return VectorD<int,d>::Zero(); }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
////Index operations
template<int d> int Grid<d>::Index(const Vector<int, d>& coord, const Vector<int, d>& counts) {return Vector<int,d>::Zero(); }
